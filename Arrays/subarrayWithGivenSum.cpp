...
Keep calculating cumulative sums and add in set
At the same time, find "cumSum - Target" and see if it's already present in set or not.
1 3 6 10 15 21 28 36

For instance, at index 5, cumSum = 21
Now, cumSum-Target = 21-15 = 6
which is available in the set.

Now, since we need to keep a track of index also therefore, we can
use an unordered_map where key = cumSum and val = index.
